    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-up": {
          ...
          "12%": { transform: "translateY(-8px) scale(1.2)", opacity: "1" },
      ...
      animation: {
        ...
        "float-up": "float-up 1.5s cubic-bezier(0.22, 0.61, 0.36, 1) forwards",
        "ripple-expand": "ripple-expand 0.7s cubic-bezier(0.22, 1, 0.36, 1) forwards",
